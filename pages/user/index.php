 ...
 <?php
  ...
  ?>
        ...
        <div class="info">
          ...
          <a href="#" class="d-block font-weight-bold">Halo, <?php echo $_SESSION['nama']; ?></a>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title new">
                  Timbang <span class="text-danger">sampah</span>mu sekarang!
                </h3>
                <a href="add_sampah.php" class="btn btn-primary btn-sm float-right">Klik Disini</a>
